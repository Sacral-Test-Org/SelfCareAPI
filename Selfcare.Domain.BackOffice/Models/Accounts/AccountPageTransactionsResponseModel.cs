...
// Type: Selfcare.Domain.BackOffice.Models.Accounts.AccountPageTransactionsResponseModel
...
{
  public class AccountPageTransactionsResponseModel
  {
    public IEnumerable<AccountTransactionsResponseModel> List { get; set; }
