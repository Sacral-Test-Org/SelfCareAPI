...
// Type: Selfcare.Infrastructure.Logging.LoggerFactory
...
namespace Selfcare.Infrastructure.Logging
{
  ...
  {
    private static readonly ILogger logger = (ILogger) new Logger();

    public static ILogger GetLogger() => LoggerFactory.logger;
  }
}
