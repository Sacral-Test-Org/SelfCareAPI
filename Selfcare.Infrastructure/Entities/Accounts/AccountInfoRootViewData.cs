...
// Type: Selfcare.Infrastructure.Entities.Accounts.AccountInfoRootViewData
...
{
  public class AccountInfoRootViewData
  {
    public List<AccountInfoViewData> Accounts { get; set; }
  }
}
