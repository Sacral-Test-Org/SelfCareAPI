...
// Type: Selfcare.Infrastructure.Services.IFAQService
...
namespace Selfcare.Infrastructure.Services
{
  ...
  {
    Task<BackOfficeApiResult<IEnumerable<FAQViewData>>> GetFAQAsync();

    Task<BackOfficeApiResult<IEnumerable<FAQCategoryViewData>>> GetFAQCategoriesAsync();
  }
}
